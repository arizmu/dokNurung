...
unset($__errorArgs, $__bag); ?>"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-5">
                                <input type="text" class="form-control" placeholder="Jawaban 3"
                        ...
                        <div class="form-group row">
                            <div class="col-md-5">
                                <input type="text" class="form-control" placeholder="Jawaban 4"
                        ...
                        <div class="form-group row">
                            <div class="col-md-5">
                                <input type="text" class="form-control" placeholder="Jawaban 5"
                                    name="input[5][jawaban]">
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control" placeholder="Score"
                                    name="input[5][score]">
            ...
            <table class="table table-bordered">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td colspan="5" class="" style="font-weight: bold">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/livewire/penilaian/soal-create.blade.php ENDPATH**/ ?>