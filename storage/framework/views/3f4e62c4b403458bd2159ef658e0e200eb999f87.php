                                    ...
                                    <div class="col-md-8">
                                        <div class="item-content">
                                            ...
                                            <a class="bg-primary text-white rounded-pill py-2 px-3 item-bottom"
                                                href="<?php echo e(route('public.detail.edukasi', $item->slug)); ?>"> Selengkapnya
                                            </a>
                                        </div>
                                    </div>
                                </div>
...
<?php endif; ?>
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/pages/edukasi/data.blade.php ENDPATH**/ ?>