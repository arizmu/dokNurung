    ...
    <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid img" src="<?php echo e(asset('img/img4.jpeg')); ?>" alt="">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid img" src="<?php echo e(asset('img/g805.png')); ?>" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(0, 0, 0, .2);">
                    <div class="container gokil">
                        <div class="row justify-content-start">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid img" src="<?php echo e(asset('img/img3.jpg')); ?>" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(0, 0, 0, .2);">
                    <div class="container gokil">
                        <div class="row justify-content-start">
...
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/livewire/index/carousel.blade.php ENDPATH**/ ?>