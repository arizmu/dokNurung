            ...
            <div class="col-md-8">
                <div class="card">
                    <form action="<?php echo e(route('penilaian.selesai')); ?>" method="POST">
                        ...
                        <input name="jml_soal" type="hidden" value="<?php echo e($test->soal->count()); ?>">
...
<?php endif; ?>
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/pages/penilaian/test.blade.php ENDPATH**/ ?>