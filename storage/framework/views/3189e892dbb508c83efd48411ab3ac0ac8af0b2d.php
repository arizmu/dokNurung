...
<?php $component->withAttributes([]); ?>
    <div class="container-xxl py-5 page-header position-relative mb-5">
        <div class="container py-5">
            <h1 class="display-2 text-white animated slideInDown mb-4">Penilaian</h1>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <h1 class="mb-3">Penilaiaan List</h1>
                        <p></p>
                    </div>
                    <div class="row">
                            ...
                            <div class="col-md-4 py-2">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Jumlah Soal - <?php echo e($item->jumlah_soal); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\pro-naira\resources\views/pages/penilaian/index.blade.php ENDPATH**/ ?>