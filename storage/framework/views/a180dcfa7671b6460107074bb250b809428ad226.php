                                    ...
                                    <div class="col-md-8">
                                        <div class="item-content">
                                            ...
                                            <a class="bg-primary text-white rounded-pill py-2 px-3 item-bottom"
                                                href="<?php echo e(route('artikel.detail', $item->title)); ?>">Read more</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\laragon\www\pro-naira\resources\views/livewire/artikel/public-data.blade.php ENDPATH**/ ?>