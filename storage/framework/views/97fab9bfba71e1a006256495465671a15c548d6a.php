            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <span class="title-post">
                        By : Admin || Post : <i><?php echo e($tanggal); ?></i>
                    </span>
                    <div class="content-edukasi">
                        <img src="<?php echo e($img); ?>" alt="" class="img-fluid shadow rounded mt-2"
                            width="100%">
                        <hr class="shadow">
...
<?php endif; ?>
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/pages/artikel/detail.blade.php ENDPATH**/ ?>