                    ...
                    <div class="card-body">
                        <div style="padding: 15pt">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input class="class="form-check-input" " type="radio" name="jenis_kelamin" value="Laki-laki"> Laki-laki
                                    </div>
                                    <div class="col-md-6">
                                        <input class="class="form-check-input" " type="radio" name="jenis_kelamin" value="Perempuan"> Perempuan
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                <label class="mb-1">Sekolah</label>
                                <input class="form-control" type="text" name="sekolah" placeholder="Nama Sekolah" />
                            </div>
                            <div class="form-group mb-4">
...
<?php endif; ?>
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/pages/register.blade.php ENDPATH**/ ?>