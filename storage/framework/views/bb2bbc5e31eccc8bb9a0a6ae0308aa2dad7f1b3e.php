...
<?php $component = $__env->getContainer()->make(App\View\Components\Form\Input::class, ['title' => 'Judul','name' => 'title','type' => 'text','value' => ''.e($data->title).'','status' => 'false'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Form\Txteditor::class, ['value' => ''.$data->content.''] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\pro-naira\resources\views/livewire/edukasi/edit-edukasi.blade.php ENDPATH**/ ?>