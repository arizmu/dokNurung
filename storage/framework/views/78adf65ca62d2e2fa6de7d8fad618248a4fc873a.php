...
} elseif ($_instance->childHasBeenRendered('ze8kRML')) {
    $componentId = $_instance->getRenderedChildComponentId('ze8kRML');
    $componentTag = $_instance->getRenderedChildComponentTagName('ze8kRML');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ze8kRML');
} else {
    $response = \Livewire\Livewire::mount('index.carousel');
    $html = $response->html();
    $_instance->logRenderedChild('ze8kRML', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <!-- Carousel End -->
...
} elseif ($_instance->childHasBeenRendered('oH0xA73')) {
    $componentId = $_instance->getRenderedChildComponentId('oH0xA73');
    $componentTag = $_instance->getRenderedChildComponentTagName('oH0xA73');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oH0xA73');
} else {
    $response = \Livewire\Livewire::mount('testimoni.vtestimoni');
    $html = $response->html();
    $_instance->logRenderedChild('oH0xA73', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH /home/u669691855/domains/gigikubersihdansehat.com/public_html/laravel/resources/views/index.blade.php ENDPATH**/ ?>